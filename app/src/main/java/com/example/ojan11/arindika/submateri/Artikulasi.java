...
public class Artikulasi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_artikulasi);
        ...
        TextView t11 = (TextView)findViewById(R.id.at);
        TextView t12 = (TextView)findViewById(R.id.tmain);
